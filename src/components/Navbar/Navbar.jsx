        ...
        <div  className={`absolute top-[100%] mx-0 left-0 mt-1 p-[1vw] rounded-md bg-gray-100 shadow-md border border-green-300 `}   >
          <div  className={` font-serif font-medium min-w-[15vw] text-slate-600 text-[1.25vw]`}   >
            ...
            <div>
            {
              (category === 'candidate') ? (
                <NavLink to="/candidate/Dashboard">
                  <button  className={`hover:underline hover:text-green-400 pb-[1vw] `}   >DashBoard</button>
                </NavLink>
              ) : ""
...

            {
              (category === 'employer') ? (
                <NavLink to="/PostaJob">
                  <div  className={`Post_a_Job bg-green-700 p-[0.75vw] rounded-md text-white font-bold hover:bg-green-600 text-[1.5vw] `}   >
            ...
            }
            {
              (category === 'candidate') ? (
                <NavLink to="/jobs">
                  <div  className={` Apply_a_Job bg-green-700 p-[0.75vw] rounded-md text-white font-bold hover:bg-green-600 text-[1.5vw]`}   >
                    <WorkOutlineIcon style={{ fontSize: '2vw' }} />
                    Apply a Job
                  </div>
                </NavLink>
