...
function Candidate() {
  ...
  return (
    <>
    <div  className={`flex `} >
      <div  className={`left hidden md:block max-h-[100rem] `} >
        <img src={FullLogo} alt="logo"  className={` min-w-[50vw]`}  />
      </div>
      <div class="right flex flex-col justify-center items-center bg-gray-400 max-h-[100rem] min-w-[100vw] sm:min-w-0">
