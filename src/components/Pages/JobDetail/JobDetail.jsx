...
function JobDetail() {
  ...
  return (
    <div className={` max-w-screen-2xl mx-auto `} >
      ...
      <div className={`Detail-box-Upper-Part flex flex-col max-w-screen-2xl mx-auto bg-gray-100 ${isMobile ? 'm-[0vw]' : 'm-[10vw]'} ${isMobile ? 'py-[5vw]' : 'py-[10vw]'}  ${isMobile ? 'pl-[5vw]' : 'pl-[10vw]'} rounded-md`}>
        <div className={`text-green-400 font-serif font-bold ${isMobile ? 'text-[4vw]' : 'text-[2vw]'}`} >Job Description :</div>
        <div className={`font-serif ${isMobile ? 'text-[4vw]' : 'text-[1.5vw]'} `} >{jobProfile.jobDetail}</div>

        <div className={` text-green-400 font-serif font-bold ${isMobile ? 'text-[4vw]' : 'text-[2vw]'}`} >Total Posts :</div>
        <div className={`font-serif ${isMobile ? 'text-[4vw]' : 'text-[1.5vw]'} `} >{jobProfile.posts}</div>
        <div className={`text-green-400 font-serif font-bold ${isMobile ? 'text-[4vw]' : 'text-[2vw]'} py-[0.5vw] `} >Responsibilies :</div>
        <div className={` font-serif`} >
          <div className={`${isMobile ? 'text-[3vw]' : 'text-[1.5vw]'} `} >
