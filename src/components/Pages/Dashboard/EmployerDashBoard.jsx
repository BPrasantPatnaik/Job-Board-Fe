...
function EmployerDashBoard() {
  ...
  return (
    <div className='bg-gray-100 text-[1vw]'>
    <div className='m-[10vw] flex '>
        <div className='Left bg-slate-50 p-[1vw] m-[1vw] rounded-md max-w-auto max-h-[25vw] border border-green-200 hidden md:block relative top-[12.5vw]'>
