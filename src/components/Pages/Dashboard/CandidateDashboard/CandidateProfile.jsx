      ...
      <div className='right-top  py-[0.5vw] bg-slate-50 p-[1vw] m-[1vw] font-serif rounded-md border border-green-200 sm:text-[3vw] md:text-[1vw] '>
        ...
        <div></div>
            ...
            <div className='Resume font-serif'>
                <div>Resume : </div>
                {
                    (user.resume) ? (<div className='p-[2vw]'>
                    ...
                    </div>):(<div><input type='file' name="File" onChange={(e)=>setFile(e.target.files[0])} className='m-[2vw] border border-gray-600 px-[1vw] py-[0.5vw] relative left-[2vw]' />
                </div>)
                } 
            </div>
