...
function ProfileItem() {
  ...
  return (
    ...
    <button type="submit" className={`bg-green-500 hover:bg-green-300 text-white font-serif font-medium p-[1vw] ${isMobile ? 'text-[5vw]' : 'text-[1vw]'}   rounded-md m-[3vw] flex justify-center align-middle `}  >Save Details</button>
